...
import 'package:pokedex/data/repositories/pokemon_repository.default.dart' as _i11;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.singleton<_i12.GetAllPokemonsUseCase>(
        _i12.GetAllPokemonsUseCase(pokemonRepository: gh<_i10.PokemonRepository>()));
    gh.singleton<_i13.GetItemUseCase>(
        _i13.GetItemUseCase(itemRepository: gh<_i8.ItemRepository>()));
    gh.singleton<_i12.GetPokemonUseCase>(
        _i12.GetPokemonUseCase(pokemonRepository: gh<_i10.PokemonRepository>()));
    gh.singleton<_i12.GetPokemonsUseCase>(
        _i12.GetPokemonsUseCase(pokemonRepository: gh<_i10.PokemonRepository>()));
    gh.singleton<_i14.ItemBloc>(_i14.ItemBloc(itemRepository: gh<_i8.ItemRepository>()));
